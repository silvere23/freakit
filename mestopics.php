<?php
session_start();
require('action/topic/viewstopicactionuser.php');
require('closetopic.php');
    ...
    ?>
        <div class="cardcontain">
            ...
            <div class="contentinf">
                ...
                <div class="btn2">
                    <a href="closetopic.php?id=<?php echo $infotopic['id']; ?>" class="close-btn" style="text-decoration: none;">close</a>
                </div>
