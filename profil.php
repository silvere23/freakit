...
<body>
    ...
    <div class="link">
        <div class="edit">
            ...
            <a href="editprofil.php" style="text-decoration: none;">Edit Profil </a> 
        ...
        <div class="delete">
            ...
            <a href="../action/user/deleteuseraction.php?<?php echo $_SESSION['id']; ?>" style="text-decoration: none;">Delete Account </a> 
